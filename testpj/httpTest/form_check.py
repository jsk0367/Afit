...
#         os.remove('D:/test2/'+file)
    ...
    model = load_model(homepath+'models/pose_3_model.h5', custom_objects={'LeakyReLU':LeakyReLU})
    ...
    with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
        ...
        while cap.isOpened():
            ...
            plt.savefig('/%s_result.jpg'%file.split('.')[0])
            plt.close()
    ...
    img = Image.open('/%s_result.jpg'%file.split('.')[0])
    img = img.convert('RGB')
